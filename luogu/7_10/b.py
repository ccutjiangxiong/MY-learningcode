...
def divide_swing_and_conquer(number: int) -> int:
    ...
    prime_exponents_array = prime_exponents_of_a_swing_number(number,
                                                              prime_numbers)
...
def prime_exponents_of_a_swing_number(swing_number: int,
                                      prime_numbers: List[int]) -> List[int]:
...
def compute_swinging_factorial(prime_numbers: List[int],
                               prime_exponents_array: List[int]) -> int:
    swing_factorial = 1
