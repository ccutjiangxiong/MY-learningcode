...
std::vector<uint> FPSComposition(std::vector<uint> f, std::vector<uint> g, int n) {
...
std::vector<uint> PolyComposition(const std::vector<uint> &f, const std::vector<uint> &g, int n) {
